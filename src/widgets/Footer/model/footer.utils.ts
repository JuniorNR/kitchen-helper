...
export const seasonToGradientDark: Record<Season, string> = {
	winter:
		'linear-gradient(180deg, rgba(30,58,138,0.65) 0%, rgba(30,64,175,0.45) 60%, rgba(15,23,42,0.12) 100%)',
	spring:
		'linear-gradient(180deg, rgba(77,124,15,0.60) 0%, rgba(101,163,13,0.45) 60%, rgba(15,23,42,0.12) 100%)',
	summer:
		'linear-gradient(180deg, rgba(21,128,61,0.65) 0%, rgba(22,163,74,0.45) 60%, rgba(15,23,42,0.12) 100%)',
	autumn:
		'linear-gradient(180deg, rgba(202,138,4,0.6) 0%, rgba(234,88,12,0.45) 60%, rgba(15,23,42,0.12) 100%)',
};
